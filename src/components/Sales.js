...
class Sales extends React.Component{
    ...
    calcular() {
        let valor1 = document.getElementById('unitary').value;
        let valor2 = document.getElementById('qty').value;
        let valor3 = document.getElementById('discount').value;
        let total = valor1 * valor2;
        let total2 = total - valor3;
    ...
    agregar() {
        ...
        document.getElementById('table').innerHTML += '<td></td><td>'+cantidad+'</td><td>'+total+'</td>';
    }
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" type="number" name="discount" id="discount" onChange={this.calcular}/>
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label className="label-control" >Total</label>
                                        <input className="form-control" type="number" name="total" id="total" value="0"/>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <button className="btn btn-primary btn-block" onClick={this.agregar}>
